...
ActiveRecord::Schema[7.0].define(version: 2022_04_28_055918) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "messagetable_type"
    t.string "messagetable_id"
  end
  ...
  create_table "polymorphicomments", force: :cascade do |t|
    t.text "content"
    t.string "commentable_type", null: false
    t.integer "commentable_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["commentable_type", "commentable_id"], name: "index_polymorphicomments_on_commentable"
  end
